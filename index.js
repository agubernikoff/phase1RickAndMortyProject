...
function renderCharactersList(data) {
  ...
  rick.addEventListener("click", function() {
    const audio3 = new Audio("audio/WUBBA LUBBA DUB DUB - AUDIO FROM JAYUZUMI.COM.mp3");
    audio3.play();
  })
  ...
  summer.addEventListener("click", function() {
    const audio3 = new Audio("audio/I AM TOTALLY FINE - AUDIO FROM JAYUZUMI.COM.mp3");
    audio3.play()
  })
  ...
  jerry.addEventListener("click", function() {
    const audio3 = new Audio("audio/HAVE YOU EVER TRIED TO RELAX - AUDIO FROM JAYUZUMI.COM.mp3");
    audio3.play()
  })
